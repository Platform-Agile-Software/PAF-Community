...
{
	/// <summary>
	/// Interface for comparing floats adds a parameterized comparator.
	...
	/// </contribution>
	/// </history>
	public interface IPAFFloatEquatable: IPAFEquatable<float>
	{
		/// <summary>
		...
		/// </returns>
		bool AreEqual(float value, float otherValue, float epsilon);
	}
}