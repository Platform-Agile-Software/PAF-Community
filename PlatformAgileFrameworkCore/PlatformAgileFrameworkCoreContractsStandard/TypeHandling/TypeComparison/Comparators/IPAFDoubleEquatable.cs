...
{
	/// <summary>
	/// Interface for comparing doubles adds a parameterized comparator.
	...
	/// </contribution>
	/// </history>
	public interface IPAFDoubleEquatable: IPAFEquatable<double>
	{
		/// <summary>
		...
		/// </returns>
		bool AreEqual(double value, double otherValue, double epsilon);
	}
}
