...
namespace Xamarin.FormsTestRunner.Views
{
	...
	public partial class TestResultsSummaryPage : ContentPage, ISwipeCallBack
	{
		...
		public int DoubleClickTimeInMilliseconds { get; set; } = 5000;
		/// <summary>
		...
		async void OnItemSelected(object sender, SelectedItemChangedEventArgs args)
		{
			...
			//m_SelectionListener.ReceiveClick(item,
			//	SharedXamlApplication.UISynchronizationContext);
		}
		...
		/// expand it. In this class, it represents a double click
		/// on a list item.
		/// </param>
		/// <param name="sender">
