...
namespace PAF.UWP.FileAndIO.FileAndDirectoryService
{
	/// <summary>
	...
	public class PAFStorageServiceUWP : PAFStorageServiceAbstract
	{
		internal static StorageFolder m_Folder = ApplicationData.Current.LocalFolder;
		/// <summary>
